...
export const CHARACTERS: CharacterInfo[] = [
  { id: "AUSSIE",       name: "Blue the Guide",      emoji: "🎣", tagline: "Sun-leathered NQ barra legend",        color: "#00d4aa" },
  ...
  { id: "BURGUNDY",     name: "Ron Burgundy",          emoji: "📺", tagline: "Kind of a big deal on NQ waters",    color: "#b8860b" },
  ...
  { id: "MORGAN",       name: "Morgan Freeman",        emoji: "🎬", tagline: "The voice of the NQ cosmos",         color: "#7986cb" },
