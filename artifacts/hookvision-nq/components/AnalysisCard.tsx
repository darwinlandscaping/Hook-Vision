      ...
      {analysis.crocAlert && analysis.crocWarning && (
        <View style={styles.crocWarningBox}>
          ...
          <Text style={styles.crocSafetyText}>
            🚨 QLD Croc Safety: Stay 5m from the water's edge. Never clean fish or wash hands at the water. Saltwater crocs can be submerged and undetected. Relocate immediately.
          </Text>
        </View>
      )}
