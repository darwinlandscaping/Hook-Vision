      ...
      {data && (
        <>
          <View style={styles.tidesHeaderRow}>
            ...
            <Text style={[styles.tidesSubtitle, { color: colors.mutedForeground }]}>Brisbane time (AEST UTC+10)</Text>
          </View>
          ...
          <View style={[styles.disclaimer, { backgroundColor: colors.secondary }]}>
            ...
            <Text style={[styles.disclaimerText, { color: colors.mutedForeground }]}>
              {data.isSecondary
                ? `Corrected from BOM primary port using standard secondary port corrections. Verify before use.`
