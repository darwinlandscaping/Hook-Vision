...
const GBR_IMG  = require("@/assets/images/splash-coral.png");
  ...
  return (
    <View style={styles.root}>
      ...
      <Animated.View style={[styles.buffContainer, { opacity: bottomOpacity }]}>
        <Image source={GBR_IMG} style={styles.buffImg} resizeMode="cover" />
...
const styles = StyleSheet.create({
  ...
  qldFlag: { position: "absolute", width: 100, height: 50, borderRadius: 3, overflow: "hidden" },
