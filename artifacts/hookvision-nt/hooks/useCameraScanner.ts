...
const PROBES: CameraProbe[] = [
  ...
  // ── Swann / NVR / ONVIF generic cameras ─────────────────────────────────────
  {
    id:           "swann-1-108",
    brand:        "Other",
    ip:           "192.168.1.108",
    ...
    snapshotPath: "/snapshot.cgi",
    timeout:      3000,
    parseInfo:    () => ({ model: "Swann Camera", manufacturer: "Swann" }),
  },
  {
    id:           "swann-1-109",
    brand:        "Other",
  ...
  },
  {
    ...
    brand:        "Other",
    ip:           "192.168.1.110",
    infoPath:     "/cgi-bin/CGIProxy.fcgi",
    cmdPath:      "/cgi-bin/CGIProxy.fcgi",
    snapshotPath: "/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2",
    timeout:      3000,
    parseInfo:    () => ({ model: "Swann NVR", manufacturer: "Swann" }),
  },
  {
    id:           "swann-0-108",
    brand:        "Other",
  ...
  },
  {
    ...
    snapshotPath: "/snapshot.cgi",
    timeout:      3000,
    parseInfo:    (j) => ({ model: j.model ?? "NVR Camera", manufacturer: j.manufacturer ?? "Generic NVR" }),
  },
  {
    id:           "nvr-1-3",
    brand:        "Other",
  ...
  {
    id:           "onvif-mjpeg-1-200",
    brand:        "Other",
    ip:           "192.168.1.200",
    infoPath:     "/onvif/device_service",
    cmdPath:      "/onvif/device_service",
    snapshotPath: "/cgi-bin/snapshot.cgi",
    timeout:      3000,
    parseInfo:    () => ({ model: "ONVIF Camera", manufacturer: "Generic" }),
  },
  {
    id:           "onvif-mjpeg-0-200",
    brand:        "Other",
    ip:           "192.168.0.200",
    infoPath:     "/snapshot.cgi",
    cmdPath:      "/snapshot.cgi",
    snapshotPath: "/snapshot.cgi",
    timeout:      3000,
    parseInfo:    () => ({ model: "WiFi Camera", manufacturer: "Generic" }),
  },
  // ── Generic ──────────────────────────────────────────────────────────────────
  {
    id:           "generic-1-1",
