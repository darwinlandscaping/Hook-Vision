...
export default function LiveScreen() {
  ...
  const { isListening: soundListening, isAnalyzing: soundAnalyzing, alert: soundAlert, startListening: soundStart, stopListening: soundStop, clearAlert: soundClear } = useSoundDetection({
    screenType:   "sonar",
    context:      { region: "Northern Territory" },
    ...
    return (
      <>
        ...
        <View style={[styles.bottomBar, { paddingBottom: botPad }]}>
          ...
          <TouchableOpacity
            style={[styles.boatModeBtn, { backgroundColor: "#0a162888", borderColor: "#aaff0066" }]}
            onPress={() => {
              if (Platform.OS !== "web") Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Heavy);
              setBoatMode((v) => !v);
              setResult(null);
          ...
          {/* Scan a saved sonar photo — REMOVED */}
          {false && (
            <TouchableOpacity
        ...
        {/* ── Floating swap feed button (removed) */}
        {false && (
          <TouchableOpacity
          style={[
            styles.swapFeedBtn,
