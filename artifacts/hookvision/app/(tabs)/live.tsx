  ...
  function renderOverlays(isNative: boolean) {
    return (
      <>
        ...
        {/* Bottom bar — always visible; content switches by mode */}
        <View style={[styles.bottomBar, { paddingBottom: botPad }]}>
          {!boatMode ? (
            <>
              {/* Normal mode scan row */}
      ...
      <View style={[styles.container, { backgroundColor: "#000" }]}>
        ...
        <View style={{ position: "absolute", bottom: insets.bottom + 56, left: 14, right: 14, gap: 8 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5 }}>
            ...
            <Text style={{ color: "#00d4aa66", fontSize: 9, fontFamily: "Inter_700Bold", letterSpacing: 1 }}>WA REGIONAL BRAIN + BARRA LIBRARY ACTIVE</Text>
          </View>
          <View style={{ flexDirection: "row", gap: 8 }}>
