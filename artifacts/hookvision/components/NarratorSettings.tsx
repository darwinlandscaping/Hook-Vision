...
export function NarratorSettings({ visible, onClose }: Props) {
  ...
  const DEMOS: Record<NarratorCharacter, string> = {
    ...
    ATTENBOROUGH: "Here, in the ancient rivers of the Kimberley, the barramundi has waited... patiently. And now — the moment of truth.",
    ...
    BURGUNDY:     "I'm Ron Burgundy, and this is a breaking fishing update. The tide is turning — much like my life at the afterparty of the 1984 San Diego Anchor Awards. Stay classy, Kimberley.",
    ...
    SAMUEL:       "I have HAD it with these fish in this WA/Kimberley water. You cast that line RIGHT NOW. Does he LOOK like a barramundi? Because I will tell you — that fish is MINE.",
