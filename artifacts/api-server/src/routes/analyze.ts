...
- \`archReasoning\` (string): A clear, concise 3-sentence expert explanation of HOW you made this identification, structured as: (1) ARCH BRIGHTNESS — state the brightness tier you observed (e.g. "Very bright orange/red arch — Tier 1, consistent with a large physostomous or physoclistous swim bladder") and which species tiers that includes/excludes. (2) DEPTH ZONE — state the exact depth from the scale and which species it matches/excludes (e.g. "Arch at 8m — inside Fingermark primary zone of 8-15m; outside Barramundi typical zone of 2-8m"). (3) HABITAT + PATTERN — state the bottom type observed and any schooling pattern, confirming the final ID and ruling out alternatives (e.g. "Hard ragged rubble bottom = Fingermark rocky reef habitat; multiple arches clustered = classic Fingermark school. Barra and Threadfin ruled out by depth and wrong substrate"). Be direct and specific — this is spoken aloud to the angler and displayed as a zoomed arch annotation.
